...
const zasticeneZivotinje = [
  {
    naziv: 'Mrki medvjed',
    opis: 'Najveći predator Romanije i strogo zaštićena vrsta. Prisustvo medvjeda u ovim šumama svjedoči o zdravom i nenarušenom ekosistemu planine.',
    slike: [{ slika: '', opis: 'Mrki medvjed — zaštićena vrsta' }],
  },
  {
    naziv: 'Sivi vuk',
    ...
    slike: [{ slika: '', opis: 'Sivi vuk u romanijskoj šumi' }],
  },
  {
    naziv: 'Planinski orao',
    opis: 'Rijetka ptica grabljivica koja gnijezdi na romanijskim stenama. Jedna od najimpresivnijih ptica ovog kraja, simbol slobode i snage.',
    slike: [{ slika: '', opis: 'Planinski orao u letu' }],
  },
  {
    naziv: 'Vidra',
    opis: 'Zaštićena vrsta koja živi uz rijeke i potoke Han Pijeska. Prisustvo vidre pouzdani je pokazatelj čistoće vodotoka.',
    slike: [{ slika: '', opis: 'Vidra uz planinski potok' }],
  },
];
  ...
  return (
    <section className="ff">
      ...
      <div className="ff__split">
       <a href="#flora" className="ff__split-pola ff__split-pola--flora"
        style={{ backgroundImage: `url(${pozadinaFlora})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
          ...
          <div className="ff__split-tekst">
            ...
            <p className="ff__split-opis">Šume, ljekovito bilje i zaštićene biljne vrste planine Javor</p>
            <span className="ff__split-dugme">Istraži floru →</span>
          </div>
        </a>
        <a href="#fauna" className="ff__split-pola ff__split-pola--fauna"
         style={{ backgroundImage: `url(${pozadinaFauna})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
          <div className="ff__split-overlay ff__split-overlay--fauna" />
          <div className="ff__split-tekst">
            <h2 className="ff__split-naslov">Fauna</h2>
            <p className="ff__split-opis">Divljač, ptice i zaštićene životinjske vrste planine Javor</p>
      ...
      <div id="flora" className="ff__sekcija">
        ...
        <div className="ff__blok">
          <div className="ff__blok-grid">
            <div className="ff__blok-tekst">
              <span className="ff__bedz ff__bedz--zeleni">Šumski ekosistem</span>
              <h2>Šume Han Pijeska</h2>
              <p>
                Više od 70% teritorije opštine Han Pijesak pokriveno je šumama,
                što ovaj kraj čini jednim od najšumovitijih u Bosni i Hercegovini.
                Dominiraju mješovite četinarsko-lišćarske šume u kojima prevladavaju
                smrča, jela, bijeli bor, bukva i hrast.
              </p>
              <p>
                Četinarske šume igraju ključnu ulogu u kvalitetu vazduha —
                oslobađaju fitoncide, prirodne antibiotike koji pozitivno djeluju
                na zdravlje čovjeka i doprinose statusu Han Pijeska kao vazdušne banje.
              </p>
            </div>
            <ImageSlider slajdovi={sumskaEkosistemSlike} visina="360px" interval={5000} />
          </div>
        </div>
        ...
        <div className="ff__blok ff__blok--alt">
          <div className="ff__blok-grid ff__blok-grid--obrnuto">
            <ImageSlider slajdovi={ljekovitoBiljeSlike} visina="360px" interval={5000} />
            <div className="ff__blok-tekst">
              <span className="ff__bedz ff__bedz--zeleni">Ljekovito bilje</span>
              <h2>Ljekovito i samoniklo bilje</h2>
              <p>
                Planinska flora Han Pijeska bogata je ljekovitim i samoraslim biljkama
                koje su generacijama korišćene u narodnoj medicini. Čist vazduh, planinska
                klima i netaknuto tlo stvaraju idealne uslove za rast bilja izuzetnih
                ljekovitih svojstava.
              </p>
              <p>
                Najpoznatije ljekovite biljke ovog kraja su kantarion, divlji luk - srijemuš,
                hajdučka trava, majčina dušica, divlja malina, divlja kupina, glog, smreka, kičica.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="ff__blok ff__blok--alt">
          <div className="ff__blok-grid">
            <div className="ff__blok-tekst">
              <span className="ff__bedz ff__bedz--zeleni">Gljive i lišajevi</span>
              <h2>Gljive i lišajevi </h2>
              <p>
                Šume Javor planine su pravi raj za ljubitelje gljiva. Zahvaljujući
                vlažnoj planinskoj klimi i bogatom šumskom tlu, ovdje rastu mnoge
                jestive vrste — vrganj, lisičarka, smrčak, bukovača, jestiva krasnica, reduša su neke od
                poznatih delicija.
              </p>
              <p>
                Berba gljiva popularna je aktivnost počev od proljeća pa sve do rane
                jeseni kada su šume najplodnije.
              </p>
            </div>
            <ImageSlider slajdovi={gljiveSlike} visina="360px" interval={5000} />
          </div>
        </div>
        ...
        <div className="ff__blok">
          <div className="ff__blok-naslov-wrap">
            ...
            <p className="ff__blok-podnaslov">
              Han Pijesak je stanište nekoliko rijetkih i zakonski zaštićenih biljnih vrsta
            </p>
          </div>
      ...
      <div id="fauna" className="ff__sekcija">
        ...
        <div className="ff__blok">
          <div className="ff__blok-grid">
            <div className="ff__blok-tekst">
              ...
              <p>
                Šume Han Pijeska dom su bogatoj populaciji krupne i sitne divljači.
                Srndać, srna, divlja svinja i zec samo su neke od vrsta koje nastanjuju
                romanijsko planinsko područje. Prisustvo ovako bogate faune svjedoči
                o zdravom i nenarušenom ekosistemu.
              </p>
              <p>
            ...
            <ImageSlider slajdovi={divljacSlike} visina="360px" interval={5000} />
          </div>
        </div>
        ...
        <div className="ff__blok ff__blok--alt">
          <div className="ff__blok-grid ff__blok-grid--obrnuto">
            ...
            <div className="ff__blok-tekst">
              ...
              <p>
                Područje planine Javor stanište je brojnih ptica, od kojih su mnoge
                rijetke i zaštićene. Šume i planinski vrhovi idealno su gnijezdilište
                za planinske oraše, šumske sove, djetliće i ptice grabljivice.
              </p>
              <p>
        ...
        <div className="ff__blok">
          <div className="ff__blok-grid">
            <div className="ff__blok-tekst">
              ...
              <p>
                Vode sa ovog područja pripadaju slivovima rijeke Bosne i Drine. Rječice sliva rijeke Bosne su pogodne za mušičarenje, dok su rječice drinskog sliva pogodnije za varaličarenje.
                To su brze, kristalno čiste planinske rječice i potoci. 
                Ove vode, koje su bogate kiseonikom i hranom, prirodno su stanište potočne pastrmke i njom su isključivo naseljene. 
                Ima dosta i potočnog raka, koji dijeli životni prostor sa pastrmkom.
              </p>
              <p>
                Ribolovci iz cijelog regiona dolaze zbog izvrsnih ribolovnih uslova
                i mira koji pruža planinska priroda.
              </p>
            </div>
            <ImageSlider slajdovi={ribolovSlike} visina="360px" interval={5000} />
          </div>
        </div>
        ...
        <div className="ff__blok ff__blok--alt">
          <div className="ff__blok-naslov-wrap">
            ...
            <p className="ff__blok-podnaslov">
              Han Pijesak je stanište nekoliko strogo zaštićenih životinjskih vrsta
            </p>
          </div>
          <div className="ff__vrste-grid">
