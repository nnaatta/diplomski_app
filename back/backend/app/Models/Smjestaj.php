...
{
    protected $table = 'smjestaji';

    protected $fillable = [
        'naziv', 'opis', 'br_soba', 'br_lezajeva',
        'aktivan', 'lokacija_id', 'tip_smjestaja_id', 'kontakt_osoba_id',
    ];
    ...
    // FIX: bez withTimestamps() — smjestaj_pogodnosti nema created_at/updated_at
    ...
    // hasMany na pivot model smjestajSlike
